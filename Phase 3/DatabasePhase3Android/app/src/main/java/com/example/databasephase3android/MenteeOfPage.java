...
public class MenteeOfPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView menteesPage = findViewById (R.id.menteesPage);
        menteesPage.setText(session.getUserToEditName() + " is a mentee of:");
        ...
        logoutBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                session.logoutUser();
                startActivity(new Intent(MenteeOfPage.this, LoginPage.class));
            }
        });
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MenteeOfPage.this, HomeStudentPage.class));
            }
        });

        // show all meetings student is menteeing
        ...
        tableNameCol.setText("MEETINGS MENTEE OF:");
        ...
        dropAllBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                UtilityClass.makePOST(String.format("DELETE FROM enroll WHERE mentee_id = %d", session.getUserToEditID()));
                UtilityClass.makePOST(String.format("DELETE FROM mentees WHERE mentee_id = %d", session.getUserToEditID()));
                startActivity(new Intent(MenteeOfPage.this, MenteeOfPage.class));
            }
        });
        ...
        JSONArray getMeetingsArray = UtilityClass.makePOST(String.format("SELECT meetings.meet_id, meet_name, date FROM meetings INNER JOIN enroll ON enroll.meet_id = meetings.meet_id WHERE mentee_id = %d", session.getUserToEditID()));
        ...
        for (int i = 2; i < getMeetingsArray.length() + 2; i++) {
            ...
            viewBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    startActivity(new Intent(MenteeOfPage.this, MeetingPage.class));
                }
            });
            ...
            dropBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    UtilityClass.makePOST(String.format("DELETE FROM enroll WHERE mentee_id = %d AND meet_id = %d", session.getUserToEditID(), mid));
                    // check to see if still present in enroll table, if so keep in mentees, otherwise delete
                    JSONArray is_still_mentee_array = UtilityClass.makePOST(String.format("SELECT * FROM enroll WHERE mentee_id = %d LIMIT 1", session.getUserToEditID()));
                    if (is_still_mentee_array == null || is_still_mentee_array.length() <= 0) {
                        UtilityClass.makePOST(String.format("DELETE FROM mentees WHERE mentee_id = %d", session.getUserToEditID()));
                    }
                    startActivity(new Intent(MenteeOfPage.this, MenteeOfPage.class));
                }
            ...
            dropFutureBtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    for (int j = 0; j < meetings_with_same_name_array.length(); j++) {
                        ...
                        UtilityClass.makePOST(String.format("DELETE FROM enroll WHERE mentee_id = %d AND meet_id = %d", session.getUserToEditID(), new_mid));
                    }
                    // check to see if still present in enroll table, if so keep in mentees, otherwise delete
                    JSONArray is_still_mentee_array = UtilityClass.makePOST(String.format("SELECT * FROM enroll WHERE mentee_id = %d LIMIT 1", session.getUserToEditID()));
                    if (is_still_mentee_array == null || is_still_mentee_array.length() <= 0) {
